                ...
                <div class="container-fluid">
                    ...
                    <form action="/products/store" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter product title" value="<?php echo $product ?>" >
                            <span><?php // if($validation->hasError('name')){echo validation_show_error('name'); } ?></span>
                        </div>
                        <div class="form-group">
                            <label for="category">Product Category</label>
                            <input type="text" class="form-control" id="category" name="category" placeholder="Enter product category" value="<?php echo $category ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="model" name="model" placeholder="Enter product model" value="<?php echo $model ?>">
                        </div>
